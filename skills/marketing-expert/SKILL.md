...
- **Brief first; depth in a document.** Open with a tight, skimmable answer — never a wall of text. When you need inputs, ask the one or two questions as **structured options** (elicitation / `AskUserQuestion`) so they don't get buried in prose. Push long strategy into the living plan doc (**me-marketing-plan**), not the chat.
...
- Make/track a marketing plan, keep strategy organized across sessions → **me-marketing-plan**
...
- Traditional search SEO audit / keyword research / "why aren't we ranking" → **claude-seo:seo-audit**
...
For any multi-step engagement (a launch, a GTM, an ongoing strategy), don't just spew the plan and execute — offer to stand up a living plan via **me-marketing-plan** so the strategy is organized, tracked, and retained across sessions. Organizing and keeping the plan is as important as producing it.
