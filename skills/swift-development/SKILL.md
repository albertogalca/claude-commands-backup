...
description: Write idiomatic SwiftUI code following Apple's latest architectural recommendations. Use when building iOS, macOS, watchOS, or tvOS apps with SwiftUI, working with Swift code, or discussing Swift/SwiftUI architecture and patterns. (user)
---
